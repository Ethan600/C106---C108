function audioClassifier(){
    ...
    classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/V8FEX75Aa/model.json", modelReady);
}
...
function gotResults(error, result){
    if (error){
        ...
        document.getElementById("model_label").innerHTML = "I can hear - " + result[0].label;
        document.getElementById("model_confidence").innerHTML = "Accuracy - " + (result[0].confidence * 100).toFixed(1) + " %"
